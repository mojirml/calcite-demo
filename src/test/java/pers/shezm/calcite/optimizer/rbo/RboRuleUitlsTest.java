...
import pers.shezm.calcite.BaseTest;
...
import pers.shezm.calcite.test.Test5;
import pers.shezm.calcite.test.Test7;
 ...
 * @group blade_db
 * @date 2022/8/15
 * @Description -da 关闭断言；注意，可以看出ProjectRemoveRules的成效，*的话会全部抹除
 */
public class RboRuleUitlsTest extends BaseTest {

  @Test
  public void testRbo() throws UnsupportedEncodingException {
...
//    String sql = "select TEST01.NAME1 from TEST01,TEST02 where TEST01.NAME1='hello' and TEST01.ID = TEST02.ID1 and __sys_convert_time(TEST02.NAME4,'yyyymm') = 100 ";
